...
<%def name="feeds()" filter="trim">
    <link href="${urls.get_url(ctx, 'api', '1', 'activities', format = 'atom')}" rel="alternate" title="${
            _(u'{} - Activities Atom feed').format(conf['realm'])}" type="application/atom+xml">
</%def>
...
<%def name="footer()" filter="trim">
        <footer class="footer">
            ...
            <p>
                ...
                <a href="http://github.com/etalab/dactylo" rel="external">dactylo</a>
                &mdash;
    ...
    <nav class="navbar navbar-default navbar-fixed-default navbar-inverse" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-topbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${model.Activity.get_admin_class_url(ctx)}">${_('Activities')}</a></li>
            </ul>
            <%self:topbar_user/>
        </div>
    </nav>
