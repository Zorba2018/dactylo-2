    ...
    conf.update(conv.check(conv.struct(
        {
            ...
            'cookie': conv.default('dactylo'),
            'database': conv.default('dactylo'),
...
#                ),
    ...
    if not errorware['debug']:
        ...
        errorware['error_subject_prefix'] = conf.get('error_subject_prefix', 'dactylo Error: ')
